% -*- mode: LaTeX; mode: TeX-PDF; coding: iso-latin-1-unix; TeX-engine: xetex; -*-
...
%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{ressubsec_1}{Cppgui}
	  \ressubitem{Autor da biblioteca cppgui de cria\c{c}\~ao de GUIs em C++, com interface utilizando {\em named parameters}
            e t\'ecnicas modernas de C++.}
          \ressubitem{Backend para QT e Win32, dando maior portabilidade sem sacrificação de look\&feel.}
	  \ressubitem{Código em Subversion disponível em http://svn.assembla.com/svn/cppgui}
	  \ressubitem{Documentação em http://www.assembla.com/wiki/show/cppgui}
	\end{ressubsec_1}

	\begin{ressubsec_1}{Linear}
	  \ressubitem{Co-autor da biblioteca ainda em desenvolvimento de programação linear.}
	  \ressubitem{A biblioteca consiste em uma Linguagem Embutida de Domínio Específico, também conhecida
	  como DSEL ou Domain Specific Embedded Language, utilizando técnicas
	    de {\em expression templates} e meta-programação para representação de problemas
	    de otimização utilizando programação linear.}
	  \ressubitem{Código em Subversion disponível em http://my-svn.assembla.com/svn/liblinear}
	  \ressubitem{http://www.assembla.com/wiki/show/liblinear}
	\end{ressubsec_1}

	\begin{ressubsec_1}{SQL}
	  \ressubitem{Autor da biblioteca sql ainda em desenvolvimento de SQL.}
	  \ressubitem{A biblioteca consiste em uma DSEL de representação SQL em C++ para consultas e transações em SQL}
	  \ressubitem{Código em Subversion disponível em http://my-svn.assembla.com/svn/sql}
	  \ressubitem{http://www.assembla.com/spaces/sql/new\_items}
	\end{ressubsec_1}
...
\begin{ressection}{Conhecimentos}
	...
	\begin{reslist}{Linguagens de Programa\c{c}\~ao:}
        ...
        \ressubitem{Autodidata - Com biblioteca contendo vários livros de computação, com mais de 12 livros só de C++. Entre outros de compiladores, influ\^encia da tipagem
		  no processo de design de software e etc.}
